	...
	public class DragPoint extends GBase
	{
		...
		private function onMouseDownHandler(evt:MouseEvent) : void
		{
			if (enabled)
			{
				...
				dispatchEvent(new UIEvent(UIEvent.HOTRECT_DRAG_START,null,true));
				trace("mouseDown dragpoint");
			}
		}
		...
		private function onMouseUpHandler(evt:MouseEvent) : void
		{
			...
			dispatchEvent(new UIEvent(UIEvent.HOTRECT_DRAG_COMPLETE,null,true));
		}
